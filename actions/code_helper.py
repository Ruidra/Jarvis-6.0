...
Rules:
- Output ONLY the code. No explanation, no Jarvisdown, no backticks.
...
Return ONLY the corrected code — no explanation, no Jarvisdown, no backticks.
...
Return ONLY the complete updated code — no explanation, no Jarvisdown, no backticks.
...
Return ONLY the optimized code — no explanation, no Jarvisdown, no backticks.
