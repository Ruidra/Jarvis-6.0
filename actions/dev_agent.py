...
Return ONLY valid JSON — no Jarvisdown, no explanation:
{{
...
General rules:
- Output ONLY raw code. Absolutely no explanation, no Jarvisdown, no triple backticks.
...
Rules:
- Output ONLY the complete fixed code. No explanation, no Jarvisdown, no backticks.
